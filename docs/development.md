...
3. Pass all integration and unit tests
4. Run benchmarks and profiler to check performance and any memory leaks
5. Run `make build-all` to verify windows build
